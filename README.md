<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=180&section=header&text=Abhishek&fontSize=42&fontColor=fff&animation=twinkling&fontAlignY=32&desc=Cybersecurity+Student+%7C+Ethical+Hacker+%7C+Full+Stack+Developer&descAlignY=62&descSize=16" width="100%"/>

<div align="center">

[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=700&size=28&duration=3000&pause=1000&color=70A5FD&center=true&vCenter=true&width=750&lines=Hey+there%2C+I'm+Abhishek+%F0%9F%91%8B;Certified+Pentester+%7C+CPT+%40+RedTeam;Full+Stack+Dev+%7C+Security+Researcher;Breaking+things+ethically+since+day+one+%F0%9F%94%90)](https://readme-typing-svg.demolab.com)
...
class Abhishek:
    ...
    stack = [
        ...
        "MySQL", "SQLite", "HTML5", "CSS3"
    ]
    
    security_tools = [
        "Nmap", "Burp Suite", "Metasploit", "Wireshark",
        "SQLMap", "Hydra", "Gobuster", "Nikto", "JohnTheRipper"
    ]
    
    currently_learning = ["Advanced Web Exploitation", "Bug Bounty Hunting", "Network Forensics"]
    
    fun_fact = "I break things legally for a living (almost 😄)"
    
    def motto(self):
        return "Hack to learn. Learn to protect. 🛡️"
```
...
| 🏅 | Achievement | Details |
|:---:|:---|:---|
| 🔐 | **Certified Pentester (CPT)** | Certified by RedTeam — covering web, network & system pentesting |
| 💡 | **Full Stack Developer** | Advanced proficiency in Python, JS, React, Flask, Node.js |
| 🕵️ | **Security Researcher** | Hands-on with Metasploit, Burp Suite, SQLMap, Hydra, Gobuster |
| 🏫 | **Top SSLC Graduate** | Scored 9 A+ and 1 A in Secondary School Leaving Certificate |
| 🌐 | **WebRTC Engineer** | Built peer-to-peer voice/video chat app from scratch |
| 🐛 | **Bug Bounty Hunter** | Actively participating in bug bounty programs |
| 🚩 | **CTF Player** | Experience exploiting FTP, SSH, MySQL, DNS, Apache in lab environments |
...
|:---|:---|:---|:---|
| Bachelor of Computer Applications (BCA) | Nehru Arts & Science College, Coimbatore | 2024 – Present (1st Year) | Ongoing |
| Higher Secondary (+2) | GHSS Kadambur | 2023 – 2025 | Completed |
| SSLC | — | — | 9 A+ · 1 A |
...
|:---:|:---|:---|
| 🔐 | Certified Pentester (CPT) | RedTeam |
...
🔍 Advanced Web Exploitation
   → SQL Injection, XSS, SSRF, XXE, IDOR, CSRF

🌐 Bug Bounty Hunting
   → Recon techniques, OSINT, Report writing, Responsible disclosure

🔒 Network Security & Forensics
   → Packet analysis, IDS/IPS, Firewall evasion, Wireshark deep dives

☁️  Secure Application Development
   → OWASP Top 10, Secure coding practices, DevSecOps basics

📱 Mobile & App Security
   → Android security, API pentesting, SSL pinning bypass
```
